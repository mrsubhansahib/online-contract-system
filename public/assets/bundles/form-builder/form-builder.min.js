    ...
    !(function (e) {
        ...
        function (t, r, o) {
            ...
            class a extends n.a {
                static get definition() {
                    return {
                        mi18n: { requireValidOption: "requireValidOption" },
                    };
                }
                build() {
                    const e = this.config,
            ...
            function I(e, t, r) {
                ...
                const _ = (t) => {
                    const { type: r } = t,
                        ...
                        l = {
                            required: () => ce(t),
                            toggle: () =>
                                ie("toggle", t, { first: c.a.get("toggle") }),
                            inline: () => {
                                const e = {
                ...
                P.on(
                    ...
                    P.on("click touchstart", ".btnAddControl", function (e) {
                        ...
                        o > n &&
                            z.css({ top: parseInt(z.css("top")) - (o - n) });
                    }),
